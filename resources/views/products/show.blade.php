        ...
        <div class="row">
            <div class="col-lg-10 col-md-12 col-lg-offset-1">
                <div class="ps-product__thumbnail">
                    <div class="ps-product__preview">
                        <div class="ps-product__variants">
                            @foreach ($product->imges as $item)
                            <div class="item"><img src="{{asset('/images/products/'.$item->imgPath)}}" alt=""></div>
                            @endforeach
                    ...
                    <div class="ps-product__image">
                        @foreach ($product->imges as $item)
                        <div class="item"><img class="zoom" src="{{asset('/images/products/'.$item->imgPath)}}" alt=""
                ...
                <div class="ps-product__thumbnail--mobile">
                    <div class="ps-product__main-img"><img src="{{asset('/images/products/'.$product->img)}}" alt="">
                    </div>
                ...
                <div class="ps-product__info">
                    ...
                    <h1>{{$product->name}}</h1>
                    <p class="ps-product__category"><a href="#"> Men shoes</a>,<a href="#"> </a>,<a href="#">
                            Jordan</a></p>
                    ...
                    <div class="ps-product__block ps-product__size">
                        ...
                        <form method="POST" action="{{route('cart')}}" id="addToCart">
                            ...
                            <div class="form-group">
                                <input class="form-control" name="quntity" type="number" value="1">
                            </div>
                            @csrf
                        </form>
                    </div>
                    <div class="ps-product__shopping">
                        ...
                        <a class="ps-btn mb-10" href="#" onclick="document.getElementById('addToCart').submit()">Add to
                            cart<i class="ps-icon-next"></i></a>
                ...
                <div class="ps-shoes--carousel">
                    <div class="ps-shoe">
                        ...
                        <div class="ps-shoe__content">
                            ...
                            <div class="ps-shoe__detail"><a class="ps-shoe__name" href="product-detai.html">Air Jordan 7
                                    Retro</a>

                            ...
                            <div class="ps-shoe mb-30">
                                <div class="ps-shoe__thumbnail">
                                    ...
                                    <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a
                                        class="ps-shoe__favorite" href="{{route('show.product' , [$product->id])}}"><i
                                            class="ps-icon-heart"></i></a><img
                                        src="{{asset('/images/products/'.$product->img)}}" alt=""><a
                                        class="ps-shoe__overlay" href="{{route('show.product' , [$product->id])}}"></a>
                                </div>
                                ...
                                <div class="ps-shoe__content">
                                    <div class="ps-shoe__variants">
                                        <div class="ps-shoe__variant normal">
                                            ...
                                            <img src="{{asset('/images/products/'.$item->imgPath)}}" alt="">
                                            @endforeach
                                    ...
                                    <div class="ps-shoe__detail"><a class="ps-shoe__name"
                                            href="#">{{$product->name}}</a>
                                        <p class="ps-shoe__categories"><a href="#"></a>,<a href="#">
                                                {{$product->name}}</a>,<a href="#"> Jordan</a></p><span
                    ...
                    <div class="ps-shoe">
                        <div class="ps-shoe__thumbnail">
                            <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite" href="#"><i
                                    class="ps-icon-heart"></i></a><img
                                src="{{asset('/images/products/'.$product->img)}}" alt=""><a class="ps-shoe__overlay"
                        ...
                        <div class="ps-shoe__content">
                            <div class="ps-shoe__variants">
                                ...
                                <div class="ps-shoe__detail"><a class="ps-shoe__name"
                                    ...
                                    <p class="ps-shoe__categories"><a href="#">{{ $product->category_name }}</a></p>
